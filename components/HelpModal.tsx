    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm">
      <div className="bg-white rounded-[2.5rem] shadow-2xl max-w-2xl w-full p-10 relative overflow-hidden">
        ...
        <div className="mb-8">
          ...
          <h2 className="text-3xl font-black text-slate-900 tracking-tight mb-2">How to Use Presti<span className="text-purdue" style={{ fontFamily: "'Pixelify Sans', sans-serif", fontWeight: 700, fontSize: '1.05em', verticalAlign: 'baseline', display: 'inline-block', transform: 'translateY(0.02em)' }}>digitizer</span></h2>
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-500 leading-relaxed">Our AI transcribes handwriting and printed text into LaTeX and semantic HTML, preserving diagrams as accessible figures.</p>
                </div>
              </div>
              <div className="flex gap-4">
                <div className="flex-shrink-0 w-8 h-8 bg-slate-100 rounded-full flex items-center justify-center text-xs font-black text-slate-400">04</div>
                <div>
